    ...
    <el-row class="container">
        ...
        <el-col :span="24" class="topbar-wrap">
            ...
            <div class="topbar-title topbar-btn">
                <span>元通汽车金融管理系统</span>
            </div>
            <div class="topbar-account topbar-btn">
                <el-dropdown trigger="click">
                    <span class="el-dropdown-link userinfo-inner"><img src="../assets/images/forest.png"> 你好，业务员{{sysUserName}}  <i class="iconfont icon-down"></i></span>
        ...
        <el-col :span="24" class="main">
            ...
            <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
                ...
                <!--菜单展开时的显示情况-->
                <el-menu class="el-menu" default-active="0" @open="handleOpen" @close="handleClose"  router>
                    <template v-for="(item,index) in $router.options.routes" v-if="item.menuShow">
